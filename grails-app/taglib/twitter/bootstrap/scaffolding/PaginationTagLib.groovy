...
class PaginationTagLib {
	...
	def paginate = { attrs ->
		...
		if (currentstep > firststep) {
			...
			prevLinkAttrs += [title: (attrs.prev ?: messageSource.getMessage('paginate.prev', null, 
		...
		if (currentstep < laststep) {
			...
			nextLinkAttrs += [title: (attrs.next ? attrs.next : messageSource.getMessage('paginate.next', null, 
