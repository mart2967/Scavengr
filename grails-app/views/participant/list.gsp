		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<th class="header"><g:message code="participant.myUser.label" default="My User" /></th>
					...
					<g:each in="${participantInstanceList}" var="participantInstance">
						<tr>
							...
							<td>${fieldValue(bean: participantInstance, field: "myUser")}</td>
						
							<td class="link">
								<g:link action="show" id="${participantInstance.id}" class="btn btn-small">Show &raquo;</g:link>
							</td>
						</tr>
					</g:each>
					</tbody>
				...
				<div class="pagination">
					<bootstrap:paginate total="${participantInstanceTotal}" />
				</div>
			</div>
