...
class User {
    ...
    static hasMany = [myHunts:Hunt, myAdministratedHunts:Hunt, myCreatedHunts:Hunt, myPhotos:Photo, favorites:Photo, bannedFrom:Hunt, recieved:Notification, sent:Notification] //, myParticipants:Participant]
    static mappedBy = [myHunts:'myUsers', myAdministratedHunts:'myAdmins', myCreatedHunts:'myCreator', bannedFrom:'bannedUsers', recieved:'recipient', sent:'sender', myPhotos:'myUser', favorites:'likedBy']
    static mapping = {
