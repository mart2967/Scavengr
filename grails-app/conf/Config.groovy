...
bi.Photo = [
    outputDir: '/WEB-INF/userPhotos',
    prefix: 'Scavengr',
    images: [/*'original':[scale:[width:1920, height:1200, type:ScaleType.APPROXIMATE]],*/
        'medium':[scale:[width:275, height:275, type:ScaleType.ACCURATE]],
        'large':[scale:[width:870, height:600, type:ScaleType.APPROXIMATE]],
...
authenticationUserClass = scavengr.User
...
// scaffolding templtes configuration
