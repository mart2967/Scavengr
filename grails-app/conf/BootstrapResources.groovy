...
modules = {
    'bootstrap-fixtaglib' {
        ...
        resource url:[plugin: twitterBootstrap, dir: css, file: 'bootstrap-fixtaglib.css'], disposition: head
    }
    'bootstrap-css' {
    ...
    'bootstrap-responsive-css' {
        ...
        resource url:[plugin: twitterBootstrap, dir: css, file: (dev ? 'bootstrap-responsive.css' :
                        'bootstrap-responsive.min.css')], disposition: head, exclude:'minify'
    }
    'bootstrap-alert' {
        defaultBundle configDefaultBundle
        if (jqueryPlugin) {
